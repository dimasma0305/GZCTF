...
internal static class IdentityExtension
{
    extension(WebApplicationBuilder builder)
    {
        public void ConfigureIdentity()
        {
            ...
            // External OAuth (Google / Discord) is handled by a self-contained gateway in
            // AccountController.External.cs (single /api/oauth/callback redirect URI, manual code
            // exchange) — no ASP.NET per-provider auth handlers are registered here.
